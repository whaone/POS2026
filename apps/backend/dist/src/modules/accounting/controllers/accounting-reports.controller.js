...
let AccountingReportsController = class AccountingReportsController {
    ...
    getCashFlow(req, startDate, endDate) {
        return this.accountingService.getCashFlow(req.user.businessId, startDate ? new Date(startDate) : undefined, endDate ? new Date(endDate) : undefined);
    }
};
