...
export declare const payrolls: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "payrolls";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
...
export declare const commissionAgents: import("drizzle-orm/pg-core").PgTableWithColumns<{
